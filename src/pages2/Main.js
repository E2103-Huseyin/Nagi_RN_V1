...
const Main = (props) => {
    const [hesap, setHesap] = useState([
        ...
        {id:"2", text:'bel/kalça oranı hesaplama', tik:true, url:"https://images.unsplash.com/photo-1470167290877-7d5d3446de4c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" },
